        ...
        <div className="relative flex justify-center ">
            ...
            `}>
                ...
                <div className="flex gap-2">
                    <button onClick={popOut} className={`btn btn-sm ${ videoIndex === 5 || videoIndex === 0 ? 'border-slate-50 bg-transparent text-slate-50 hover:bg-slate-50 hover:text-slate-800' : 'bg-transparent border-slate-800 text-slate-800 hover:text-slate-50 hover:bg-slate-800' } cursor-pointer border-[1px]`}>Deny</button>
