        ...
        <div id="faqs" className="relative ">
            ...
            <div className=" 
                ...
                <div id="connect-button" className="flex xl:justify-end justify-between xl:gap-2 opacity-0">
                    ...
                    <button  className={` 
                        ${ videoIndex === 2 ? 'bg-transparent text-slate-800' : '' } 
                        ${ videoIndex === 1 ? 'bg-slate-50 text-slate-800 border-slate-50' : '' }  
                        ${ videoIndex === 0 ? 'bg-transparent border-slate-50 text-slate-50' : '' }
                        faq-btn group btn  hover:bg-white hover:text-slate-800 hover:border-slate-50 `} >
                        <svg className={` 
                            ${ videoIndex === 2 || videoIndex === 1 ?  'fill-slate-800' : '' } 
                            ${ videoIndex === 0 ? 'fill-slate-50 group-hover:fill-slate-800' : '' } 
                            w-4 group-hover:-translate-y-1 duration-200 `} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <button  className={`
                    faq-btn btn btn-neutral text-slate-50 group btn-info
                    ${ videoIndex === 2 ? 'btn-warning text-slate-800' : 'btn-info' } 
                    
                    `}>Connect
                    
                        <svg className={`
                        w-4 group-hover:translate-x-1 group-hover:-translate-y-1 duration-200 fill-slate-50
                        ${ videoIndex === 2 ? 'fill-slate-800' : '' }     
