...
export default function FAQ({ videoIndex }) {
    ...
    return (
        <div id="faqs" className="relative ">
            ...
            <div className=" 
                absolute right-10 duration-200 
                lg:bottom-10 lg:scale-70 w-[25rem]
                xl:right-10 xl:bottom-20 xl:w-[30rem] xl:scale-100
                2xl:bottom-52  2xl:w-[45rem]
                flex flex-col gap-2
                ">
                ...
                <div id="connect-button" className="flex xl:justify-end justify-between xl:gap-2 opacity-0">
                    ...
                    <button  className={` ${ videoIndex === 2 ? 'border-slate-800 text-slate-800' : 'border-slate-200 text-slate-200' } ${ videoIndex === 3 ? 'bg-slate-50 text-slate-800 border-slate-50' : '' } ${ videoIndex !== 3 ? 'bg-transparent' : '' } faq-btn group btn   hover:bg-white hover:text-black hover:border-white `} >
                        <svg className={` ${ videoIndex === 2 ?  'fill-slate-800' : 'fill-slate-200 group-hover:fill-slate-800' } ${ videoIndex === 3 ? 'fill-slate-800' : '' } w-4 group-hover:-translate-y-1 duration-200 `} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <button  className="faq-btn btn btn-neutral text-slate-50 group">Connect
                        <svg className="w-4 group-hover:translate-x-1 group-hover:-translate-y-1 duration-200 fill-slate-50" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
