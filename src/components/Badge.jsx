    ...
    return (
        ...
        ">
            ...
            <div className="flex gap-4">
                <a href="https://www.codecademy.com/learn" target="_blank" className={`badges ${ videoIndex === 2 ? 'border-slate-800' : 'border-slate-200' }  ${ videoIndex === 0 ? 'bg-[rgba(255,255,255,0.35)]' : '' } `}>
                ...
                <a href="https://www.udemy.com/" target="_blank" className={`badges ${ videoIndex === 2 ? 'border-slate-800' : 'border-slate-200' }  ${ videoIndex === 0 ? 'bg-[rgba(255,255,255,0.35)]' : '' } `}>
